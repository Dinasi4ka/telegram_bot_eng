...
async def show_info(message: Message):
    await message.answer(
        ...
        "• Про перенесення необхідно повідомляти завчасно (щонайменше за 1,5 год до початку заняття)\n"
        "• Для зміни розкладу пишіть викладачу\n\n"
        "❌ <b>Скасування:</b>\n"
        "• Без списання — якщо повідомлено <b>за 1,5 години</b> до заняття\n"
        "• Якщо пізніше — заняття списується\n\n"
        "💰 <b>Оплата та баланс:</b>\n"
        "• Заняття автоматично списується за 1 годину до уроку\n"
        "• Якщо баланс не поповнений — заняття автоматично скасовується\n"
        "• Після поповнення балансу після скасування — обов'язково напишіть викладачу\n\n"
        "📩 <b>Важливо:</b>\n"
